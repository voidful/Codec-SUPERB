...
def load_data_and_model(codec_name, dataset_config="voidful/spoken-alpaca-gpt4-unit",
                        model_config="voidful/bart-base-codec"):
...
def process_data_to_model_inputs(batch, tokenizer, codec_name, max_len=1023):
    labels = tokenizer(batch["output"], padding=True, truncation=True, max_length=max_len).input_ids
